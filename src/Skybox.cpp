...
void Skybox::loadCubemap()
{
	...
	(
		...
		"../skybox/skybox_east.bmp",			//east
		"../skybox/skybox_west.bmp",			// west
		"../skybox/skybox_up.bmp",				// up
		"../skybox/skybox_down.bmp",			// down
		"../skybox/skybox_north.bmp",			// north
		"../skybox/skybox_south.bmp",			// south
		SOIL_LOAD_RGB,
		SOIL_CREATE_NEW_ID,
		SOIL_FLAG_MIPMAPS
